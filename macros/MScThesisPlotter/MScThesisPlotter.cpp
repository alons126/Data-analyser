...
//    GraphPlotter1D(MScThesisPlots, plots_momResS1_FittedPlots, "Fitted reco neutron resolution slice width", "reco_f_Smear_pol1_wKC",
//                   SampleName, MomResS1FolderSim, "01_Neutron_reco_f_Smear_pol1_wKC");
//    GraphPlotter1D(MScThesisPlots, plots_momResS1_FittedPlots, "Fitted TL neutron resolution slice width", "truth_f_Smear_pol1_wKC",
//                   SampleName, MomResS1FolderSim, "01_Neutron_truth_f_Smear_pol1_wKC");
//    GraphPlotter1D(MScThesisPlots, plots_momResS1_FittedPlots, "Fitted reco neutron resolution slice mean", "reco_f_Corr_pol1_wKC",
//                   SampleName, MomResS1FolderSim, "02_Neutron_reco_f_Corr_pol1_wKC_Important"); // Important! (correction!)
//    GraphPlotter1D(MScThesisPlots, plots_momResS1_FittedPlots, "Fitted TL neutron resolution slice mean", "truth_f_Corr_pol1_wKC",
//                   SampleName, MomResS1FolderSim, "02_Neutron_truth_f_Corr_pol1_wKC");
//
//    /* Width fit after correction (neutron) */
//    GraphPlotter1D(MScThesisPlots, plots_momResS2_FittedPlots, "Fitted reco neutron resolution slice width", "reco_f_Smear_pol1_wKC",
//                   SampleName, MomResS2FolderSim, "01_Neutron_reco_f_Smear_pol1_wKC");
//    GraphPlotter1D(MScThesisPlots, plots_momResS2_FittedPlots, "Fitted TL neutron resolution slice width", "truth_f_Smear_pol1_wKC",
//                   SampleName, MomResS2FolderSim, "01_Neutron_truth_f_Smear_pol1_wKC_Important"); // Important! (smearing!)
//    GraphPlotter1D(MScThesisPlots, plots_momResS2_FittedPlots, "Fitted reco neutron resolution slice mean", "reco_f_Corr_pol1_wKC",
//                   SampleName, MomResS2FolderSim, "02_Neutron_reco_f_Corr_pol1_wKC");
//    GraphPlotter1D(MScThesisPlots, plots_momResS2_FittedPlots, "Fitted TL neutron resolution slice mean", "truth_f_Corr_pol1_wKC",
//                   SampleName, MomResS2FolderSim, "02_Neutron_truth_f_Corr_pol1_wKC");
//    /*
//        GraphPlotter1D(MScThesisPlots, plots_momResS2_FittedPlots, "Fitted reco neutron resolution slice width", "g_Std_pol1_wKC",
//                       SampleName, MomResS2FolderSim, "01_g_Std_pol1_wKC_Important"); // Important! (smearing!)
//        GraphPlotter1D(MScThesisPlots, plots_momResS2_FittedPlots, "Fitted reco neutron resolution slice mean", "g_Corr_pol1_wKC",
...
//               MomComp_ElecMom_2N_Reco_Sim_FolderData, "P_e_pFDpCD_FD_2N", "P_e_nFDpCD_FD_2N", "P_e_FSR_2N", 2);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "P_{pFD} vs. P_{pCD}", "P_{nFD} vs. P_{pCD}",
               "P_{nFD} vs. P_{pCD} (nFDpCD)", MomComp_NucMom_2N_Reco_Sim_FolderData, "P_pFD_vs_P_pCD_pFDpCD", "P_nFD_vs_P_pCD_nFDpCD",
               "P_nucFD_vs_P_nucCD_FSR_2N", 3);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "P_{pL} vs. P_{pR}", "P_{nL} vs. P_{nR}",
               "P_{nL} vs. P_{nR} (nFDpCD)", MomComp_NucMom_2N_Reco_Sim_FolderData, "P_pL_vs_P_pR_pFDpCD", "P_nL_vs_P_nR_nFDpCD",
               "P_nucL_vs_P_nucR_FSR_2N", 6);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "|#vec{P}_{tot}| vs. |#vec{P}_{rel}|", "|#vec{P}_{tot}| vs. |#vec{P}_{rel}|",
               "|#vec{P}_{tot}| vs. |#vec{P}_{rel}|", MomComp_TotAndRel_Mom_Sim_FolderData, "P_tot_vs_P_rel_pFDpCD", "P_tot_vs_P_rel_nFDpCD",
               "P_tot_vs_P_rel_FSR_2N", 3);

    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "1N", "TH1D", "FD", "FD TL Proton momentum AC", "FD TL Neutron momentum AC",
               "FD TL Neutron momentum AC", MomComp_NucMom_1N_TL_Sim_FolderData, "P_pFD_TL_1p", "P_nFD_TL_1n", "P_nucFD_TL_FSR_1N", 1);

    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "FD TL Proton momentum AC", "FD TL Neutron momentum AC",
               "FD TL Neutron momentum AC", MomComp_NucMom_2N_TL_Sim_FolderData, "P_pFD_TL_pFDpCD", "P_nFD_TL_pFDpCD", "P_nucFD_TL_FSR_2N", 1);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "CD TL Proton momentum AC", "CD TL Proton momentum AC",
...
//               MomComp_ElecMom_2N_Reco_Data_FolderData, "P_e_pFDpCD_FD_2N", "P_e_nFDpCD_FD_2N", "P_e_FSR_2N", 2);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "P_{pFD} vs. P_{pCD}", "P_{nFD} vs. P_{pCD}",
               "P_{nFD} vs. P_{pCD} (nFDpCD)", MomComp_NucMom_2N_Reco_Data_FolderData, "P_pFD_vs_P_pCD_pFDpCD", "P_nFD_vs_P_pCD_nFDpCD",
               "P_nucFD_vs_P_nucCD_FSR_2N", 3);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "P_{pL} vs. P_{pR}", "P_{nL} vs. P_{nR}",
               "P_{nL} vs. P_{nR} (nFDpCD)", MomComp_NucMom_2N_Reco_Data_FolderData, "P_pL_vs_P_pR_pFDpCD", "P_nL_vs_P_nR_nFDpCD",
               "P_nucL_vs_P_nucR_FSR_2N", 6);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "|#vec{P}_{tot}| vs. |#vec{P}_{rel}|", "|#vec{P}_{tot}| vs. |#vec{P}_{rel}|",
               "|#vec{P}_{tot}| vs. |#vec{P}_{rel}|", MomComp_TotAndRel_Mom_Data_FolderData, "P_tot_vs_P_rel_pFDpCD", "P_tot_vs_P_rel_nFDpCD",
               "P_tot_vs_P_rel_FSR_2N", 3);
    //</editor-fold>
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "Q^{2} (pFDpCD, FD)", "Q^{2} (nFDpCD, FD)",
               "Q^{2} (nFDpCD, FD)", InvMassComp_Sim_FolderData, "Q2_pFDpCD", "Q2_nFDpCD", "Q2_FSR", 2);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "Q^{2} vs. W (All Int., pFDpCD)",
               "Q^{2} vs. W (All Int., nFDpCD)", "Q^{2} vs. W (All Int., nFDpCD)",
               InvMassComp_Sim_FolderData, "Q2_VS_W_pFDpCD", "Q2_VS_W_nFDpCD", "Q2_VS_W_FSR_2N", 3);
    //</editor-fold>
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "FD", "Q^{2} (pFDpCD, FD)", "Q^{2} (nFDpCD, FD)",
               "Q^{2} (nFDpCD, FD)", InvMassComp_Data_FolderData, "Q2_pFDpCD", "Q2_nFDpCD", "Q2_FSR", 2);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "Q^{2} vs. W (All Int., pFDpCD)",
               "Q^{2} vs. W (All Int., nFDpCD)", "Q^{2} vs. W (All Int., nFDpCD)",
               InvMassComp_Data_FolderData, "Q2_VS_W_pFDpCD", "Q2_VS_W_nFDpCD", "Q2_VS_W_FSR_2N", 3);
    //</editor-fold>
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#theta_{e} vs. P_{e} (All Int., pFDpCD)", "#theta_{e} vs. P_{e} (All Int., nFDpCD)",
               "#theta_{e} vs. P_{e} (All Int., nFDpCD)", AngDistComp_Scattring_Ang_Sim_FolderData, "Theta_e_VS_P_e_pFDpCD", "Theta_e_VS_P_e_nFDpCD",
               "Theta_e_VS_P_e_FSR_2N", 2);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#theta_{e} vs. W (All Int., pFDpCD)", "#theta_{e} vs. W (All Int., nFDpCD)",
               "#theta_{e} vs. W (All Int., nFDpCD)", AngDistComp_Scattring_Ang_Sim_FolderData, "Theta_e_VS_W_pFDpCD", "Theta_e_VS_W_nFDpCD",
               "Theta_e_VS_W_FSR_2N", 3);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#phi_{e} vs. P_{e} (All Int., pFDpCD)", "#phi_{e} vs. P_{e} (All Int., nFDpCD)",
               "#phi_{e} vs. P_{e} (All Int., nFDpCD)", AngDistComp_Scattring_Ang_Sim_FolderData, "Phi_e_VS_P_e_pFDpCD", "Phi_e_VS_P_e_nFDpCD",
               "Phi_e_VS_P_e_FSR_2N", 4);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#phi_{e} vs. W (All Int., pFDpCD)", "#phi_{e} vs. W (All Int., nFDpCD)",
               "#phi_{e} vs. W (All Int., nFDpCD)", AngDistComp_Scattring_Ang_Sim_FolderData, "Phi_e_VS_W_pFDpCD", "Phi_e_VS_W_nFDpCD",
               "Phi_e_VS_W_FSR_2N", 5);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#theta_{pFD} vs. P_{pFD} (All Int., pFDpCD, FD)",
               "#theta_{nFD} vs. P_{nFD} (All Int., nFDpCD, FD)",
               "#theta_{nFD} vs. P_{nFD} (All Int., nFDpCD, FD)", AngDistComp_Scattring_Ang_Sim_FolderData, "Theta_pFD_VS_P_pFD_pFDpCD", "Theta_nFD_VS_P_nFD_nFDpCD",
               "Theta_nucFD_VS_P_pFD_FSR_2N", 7);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#phi_{pFD} vs. P_{pFD} (All Int., pFDpCD, FD)",
               "#phi_{nFD} vs. P_{nFD} (All Int., nFDpCD, FD)",
               "#phi_{nFD} vs. P_{nFD} (All Int., nFDpCD, FD)", AngDistComp_Scattring_Ang_Sim_FolderData, "phi_pFD_VS_P_pFD_pFDpCD", "phi_nFD_VS_P_pFD_nFDpCD",
               "phi_nucFD_VS_P_pFD_FSR_2N", 9);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#phi_{pFD} vs. W (All Int., pFDpCD, FD)", "#phi_{nFD} vs. W (All Int., nFDpCD, FD)",
               "#phi_{nFD} vs. W (All Int., nFDpCD, FD)", AngDistComp_Scattring_Ang_Sim_FolderData, "phi_pFD_VS_W_pFDpCD", "phi_nFD_VS_W_nFDpCD",
               "phi_nucFD_VS_W_FSR_2N", 10);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#theta_{pCD} vs. P_{pCD} (All Int., pFDpCD, CD)", "#theta_{pCD} vs. P_{pCD} (All Int., nFDpCD, CD)",
               "#theta_{pCD} vs. P_{pCD} (All Int., nFDpCD, CD)", AngDistComp_Scattring_Ang_Sim_FolderData, "Theta_pCD_VS_P_pCD_pFDpCD", "Theta_pCD_VS_P_pCD_nFDpCD",
               "Theta_pCD_VS_P_pCD_FSR_2N", 12);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#phi_{pCD} vs. P_{pCD} (All Int., pFDpCD, CD)", "#phi_{pCD} vs. P_{pCD} (All Int., nFDpCD, CD)",
               "#phi_{pCD} vs. P_{pCD} (All Int., nFDpCD, CD)", AngDistComp_Scattring_Ang_Sim_FolderData, "phi_pCD_VS_P_pCD_pFDpCD", "phi_pCD_VS_P_pCD_nFDpCD",
               "phi_pCD_VS_P_pCD_FSR_2N", 14);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#phi_{pCD} vs. W (All Int., pFDpCD, CD)", "#phi_{pCD} vs. W (All Int., nFDpCD, CD)",
               "#phi_{pCD} vs. W (All Int., nFDpCD, CD)", AngDistComp_Scattring_Ang_Sim_FolderData, "phi_pCD_VS_W_pFDpCD", "phi_pCD_VS_W_nFDpCD",
               "phi_pCD_VS_W_FSR_2N", 15);

    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#theta_{e} vs. #phi_{e} (All Int., pFDpCD, FD)",
               "#theta_{e} vs. #phi_{e} (All Int., nFDpCD, FD)", "#theta_{e} vs. #phi_{e} (All Int., nFDpCD, FD)",
               AngDistComp_Scattring_Ang_Sim_FolderData, "Theta_e_VS_Phi_e_pFDpCD", "Theta_e_VS_Phi_e_nFDpCD", "Theta_e_VS_Phi_e_FSR_2N", 16);

    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#phi_{pCD} vs. P_{pCD} (All Int., pFDpCD, CD)", "#phi_{pCD} vs. P_{pCD} (All Int., nFDpCD, CD)",
               "#phi_{pCD} vs. P_{pCD} (All Int., nFDpCD, CD)", AngDistComp_Scattring_Ang_Sim_FolderData, "phi_pCD_VS_P_pCD_pFDpCD", "phi_pCD_VS_P_pCD_nFDpCD",
               "phi_pCD_VS_P_pCD_FSR_2N", 17);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#phi_{pCD} vs. W (All Int., pFDpCD, CD)", "#phi_{pCD} vs. W (All Int., nFDpCD, CD)",
               "#phi_{pCD} vs. W (All Int., nFDpCD, CD)", AngDistComp_Scattring_Ang_Sim_FolderData, "phi_pCD_VS_W_pFDpCD", "phi_pCD_VS_W_nFDpCD",
               "phi_pCD_VS_W_FSR_2N", 18);

    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{tot} (All Int., pFDpCD)", "#theta_{tot} (All Int., nFDpCD)",
               "theta_tot FSRatio ()", AngDistComp_Scattring_Ang_Sim_FolderData, "Theta_tot_All_Int_pFDpCD", "Theta_tot_All_Int_nFDpCD",
               "Theta_tot_FSR_pFDpCD", 19);

    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{rel} (All Int., pFDpCD)", "#theta_{rel} (All Int., nFDpCD)",
               "theta_rel FSRatio ()", AngDistComp_Scattring_Ang_Sim_FolderData, "Theta_rel_All_Int_pFDpCD", "Theta_rel_All_Int_nFDpCD",
               "Theta_rel_FSR_pFDpCD", 20);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{tot}} (All Int., pFDpCD)",
               "#theta_{#vec{q},#vec{P}_{tot}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}_{tot}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_q_and_P_tot_Sim_FolderData, "Theta__q_and_P_tot__All_Int_pFDpCD", "Theta__q_and_P_tot__All_Int_nFDpCD",
               "Theta__q_and_P_tot__FSR", 1);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{P}_{pL}-#vec{q},#vec{P}_{pR}} (All Int., pFDpCD)",
               ...
               AngDistComp_Opening_Ang_P_L_minus_q_and_P_R_Sim_FolderData, "Theta__P_L_minus_q_and_P_R__All_Int_pFDpCD",
               "Theta__P_L_minus_q_and_P_R__All_Int_nFDpCD", "Theta__P_L_minus_q_and_P_R__FSR", 1);

    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{pL}} (All Int., pFDpCD)",
               "#theta_{#vec{q},#vec{P}_{nL}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}_{nL}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_q_and_P_L_Sim_FolderData, "Theta__q_and_P_L__All_Int_pFDpCD",
               "Theta__q_and_P_L__All_Int_nFDpCD", "Theta__q_and_P_L__FSR", 1);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{pR}} (All Int., pFDpCD)",
               "#theta_{#vec{q},#vec{P}_{nR}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}_{nR}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_q_and_P_R_Sim_FolderData, "Theta__q_and_P_R__All_Int_pFDpCD",
               "Theta__q_and_P_R__All_Int_nFDpCD", "Theta__q_and_P_R__FSR", 1);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "#theta_{#vec{q},#vec{P}_{pFD}} (All Int., pFDpCD)",
               "#theta_{#vec{q},#vec{P}_{nFD}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}_{pFD}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_q_and_P_nucFD_Sim_FolderData, "Theta__q_and_P_pFD__All_Int_pFDpCD",
               "Theta__q_and_P_nFD__All_Int_nFDpCD", "Theta__q_and_P_nucFD__FSR", 1);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{pCD}} (All Int., pFDpCD)",
               "#theta_{#vec{q},#vec{P}_{pCD}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}_{pCD}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_q_and_P_nucCD_Sim_FolderData, "Theta__q_and_P_pCD__All_Int_pFDpCD",
               "Theta__q_and_P_pCD__All_Int_nFDpCD", "Theta__q_and_P_nucCD__FSR", 1);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{pFD,pCD} (All Int., pFDpCD)",
               "#theta_{nFD,pCD} (All Int., nFDpCD)", "#theta_{nFD,pCD} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_P_FD_and_P_CD_Sim_FolderData, "Theta__Theta_pFD_pCD__All_Int_pFDpCD",
               "Theta__Theta_nFD_pCD__All_Int_nFDpCD", "Theta__Theta_nucFD_nucCD__FSR", 1);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#theta_{pFD,pCD} vs. W (All Int., pFDpCD)",
               "#theta_{nFD,pCD} vs. W (All Int., nFDpCD)", "#theta_{nFD,pCD} vs. W (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_P_FD_and_P_CD_Sim_FolderData, "Theta_pFD_pCD_vs_W_pFDpCD", "Theta_nFD_pCD_vs_W_nFDpCD", "Theta_nucFD_nucCD_vs_W_FSR_2N", 2);
    //</editor-fold>
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#theta_{e} vs. P_{e} (All Int., pFDpCD)", "#theta_{e} vs. P_{e} (All Int., nFDpCD)",
               "#theta_{e} vs. P_{e} (All Int., nFDpCD)", AngDistComp_Scattring_Ang_Data_FolderData, "Theta_e_VS_P_e_pFDpCD", "Theta_e_VS_P_e_nFDpCD",
               "Theta_e_VS_P_e_FSR_2N", 2);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#theta_{e} vs. W (All Int., pFDpCD)", "#theta_{e} vs. W (All Int., nFDpCD)",
               "#theta_{e} vs. W (All Int., nFDpCD)", AngDistComp_Scattring_Ang_Data_FolderData, "Theta_e_VS_W_pFDpCD", "Theta_e_VS_W_nFDpCD",
               "Theta_e_VS_W_FSR_2N", 3);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#phi_{e} vs. P_{e} (All Int., pFDpCD)", "#phi_{e} vs. P_{e} (All Int., nFDpCD)",
               "#phi_{e} vs. P_{e} (All Int., nFDpCD)", AngDistComp_Scattring_Ang_Data_FolderData, "Phi_e_VS_P_e_pFDpCD", "Phi_e_VS_P_e_nFDpCD",
               "Phi_e_VS_P_e_FSR_2N", 4);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#phi_{e} vs. W (All Int., pFDpCD)", "#phi_{e} vs. W (All Int., nFDpCD)",
               "#phi_{e} vs. W (All Int., nFDpCD)", AngDistComp_Scattring_Ang_Data_FolderData, "Phi_e_VS_W_pFDpCD", "Phi_e_VS_W_nFDpCD",
               "Phi_e_VS_W_FSR_2N", 5);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#theta_{pFD} vs. P_{pFD} (All Int., pFDpCD, FD)",
               "#theta_{nFD} vs. P_{nFD} (All Int., nFDpCD, FD)",
               "#theta_{nFD} vs. P_{nFD} (All Int., nFDpCD, FD)", AngDistComp_Scattring_Ang_Data_FolderData, "Theta_pFD_VS_P_pFD_pFDpCD", "Theta_nFD_VS_P_nFD_nFDpCD",
               "Theta_nucFD_VS_P_pFD_FSR_2N", 7);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#phi_{pFD} vs. W (All Int., pFDpCD, FD)", "#phi_{nFD} vs. W (All Int., nFDpCD, FD)",
               "#phi_{nFD} vs. W (All Int., nFDpCD, FD)", AngDistComp_Scattring_Ang_Data_FolderData, "phi_pFD_VS_W_pFDpCD", "phi_nFD_VS_W_nFDpCD",
               "phi_nucFD_VS_W_FSR_2N", 10);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#theta_{pCD} vs. P_{pCD} (All Int., pFDpCD, CD)",
               "#theta_{pCD} vs. P_{pCD} (All Int., nFDpCD, CD)",
               "#theta_{pCD} vs. P_{pCD} (All Int., nFDpCD, CD)", AngDistComp_Scattring_Ang_Data_FolderData, "Theta_pCD_VS_P_pCD_pFDpCD", "Theta_pCD_VS_P_pCD_nFDpCD",
               "Theta_pCD_VS_P_pCD_FSR_2N", 12);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#theta_{pCD} vs. W (All Int., pFDpCD, CD)", "#theta_{pCD} vs. W (All Int., nFDpCD, CD)",
               ...
               "Theta_pCD_VS_W_FSR_2N", 13);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#phi_{pCD} vs. P_{pCD} (All Int., pFDpCD, CD)", "#phi_{pCD} vs. P_{pCD} (All Int., nFDpCD, CD)",
               "#phi_{pCD} vs. P_{pCD} (All Int., nFDpCD, CD)", AngDistComp_Scattring_Ang_Data_FolderData, "phi_pCD_VS_P_pCD_pFDpCD", "phi_pCD_VS_P_pCD_nFDpCD",
               "phi_pCD_VS_P_pCD_FSR_2N", 14);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#phi_{pCD} vs. W (All Int., pFDpCD, CD)", "#phi_{pCD} vs. W (All Int., nFDpCD, CD)",
               "#phi_{pCD} vs. W (All Int., nFDpCD, CD)", AngDistComp_Scattring_Ang_Data_FolderData, "phi_pCD_VS_W_pFDpCD", "phi_pCD_VS_W_nFDpCD",
               "phi_pCD_VS_W_FSR_2N", 15);

    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#theta_{e} vs. #phi_{e} (All Int., pFDpCD, FD)",
               "#theta_{e} vs. #phi_{e} (All Int., nFDpCD, FD)", "#theta_{e} vs. #phi_{e} (All Int., nFDpCD, FD)",
               AngDistComp_Scattring_Ang_Data_FolderData, "Theta_e_VS_Phi_e_pFDpCD", "Theta_e_VS_Phi_e_nFDpCD", "Theta_e_VS_Phi_e_FSR_2N", 16);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "CD", "#theta_{tot} (All Int., pFDpCD)", "#theta_{tot} (All Int., nFDpCD)",
               "theta_tot FSRatio ()", AngDistComp_Scattring_Ang_Data_FolderData, "Theta_tot_All_Int_pFDpCD", "Theta_tot_All_Int_nFDpCD",
               "Theta_tot_FSR_pFDpCD", 19);

    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "CD", "#theta_{rel} (All Int., pFDpCD)", "#theta_{rel} (All Int., nFDpCD)",
               "theta_rel FSRatio ()", AngDistComp_Scattring_Ang_Data_FolderData, "Theta_rel_All_Int_pFDpCD", "Theta_rel_All_Int_nFDpCD",
               "Theta_rel_FSR_pFDpCD", 20);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{tot}} (All Int., pFDpCD)",
               "#theta_{#vec{q},#vec{P}_{tot}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}_{tot}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_q_and_P_tot_Data_FolderData, "Theta__q_and_P_tot__All_Int_pFDpCD", "Theta__q_and_P_tot__All_Int_nFDpCD",
               "Theta__q_and_P_tot__FSR", 1);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{P}_{pL}-#vec{q},#vec{P}_{pR}} (All Int., pFDpCD)",
               "#theta_{#vec{P}_{nL}-#vec{q},#vec{P}_{nR}} (All Int., nFDpCD)", "#theta_{#vec{P}_{nL}-#vec{q},#vec{P}_{nR}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_P_L_minus_q_and_P_R_Data_FolderData, "Theta__P_L_minus_q_and_P_R__All_Int_pFDpCD",
               "Theta__P_L_minus_q_and_P_R__All_Int_nFDpCD", "Theta__P_L_minus_q_and_P_R__FSR", 1);

    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{pL}} (All Int., pFDpCD)",
               "#theta_{#vec{q},#vec{P}_{nL}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}_{nL}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_q_and_P_L_Data_FolderData, "Theta__q_and_P_L__All_Int_pFDpCD",
               "Theta__q_and_P_L__All_Int_nFDpCD", "Theta__q_and_P_L__FSR", 1);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{pR}} (All Int., pFDpCD)",
               "#theta_{#vec{q},#vec{P}_{nR}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}_{nR}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_q_and_P_R_Data_FolderData, "Theta__q_and_P_R__All_Int_pFDpCD",
               "Theta__q_and_P_R__All_Int_nFDpCD", "Theta__q_and_P_R__FSR", 1);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "FD", "#theta_{#vec{q},#vec{P}_{pFD}} (All Int., pFDpCD)",
               "#theta_{#vec{q},#vec{P}_{nFD}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}_{pFD}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_q_and_P_nucFD_Data_FolderData, "Theta__q_and_P_pFD__All_Int_pFDpCD",
               "Theta__q_and_P_nFD__All_Int_nFDpCD", "Theta__q_and_P_nucFD__FSR", 1);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{pCD}} (All Int., pFDpCD)",
               "#theta_{#vec{q},#vec{P}_{pCD}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}_{pCD}} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_q_and_P_nucCD_Data_FolderData, "Theta__q_and_P_pCD__All_Int_pFDpCD",
               "Theta__q_and_P_pCD__All_Int_nFDpCD", "Theta__q_and_P_nucCD__FSR", 1);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "CD", "#theta_{pFD,pCD} (All Int., pFDpCD)",
               "#theta_{nFD,pCD} (All Int., nFDpCD)", "#theta_{nFD,pCD} (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_P_FD_and_P_CD_Data_FolderData, "Theta__Theta_pFD_pCD__All_Int_pFDpCD",
               "Theta__Theta_nFD_pCD__All_Int_nFDpCD", "Theta__Theta_nucFD_nucCD__FSR", 1);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#theta_{pFD,pCD} vs. W (All Int., pFDpCD)",
               "#theta_{nFD,pCD} vs. W (All Int., nFDpCD)", "#theta_{nFD,pCD} vs. W (All Int., nFDpCD)",
               AngDistComp_Opening_Ang_P_FD_and_P_CD_Data_FolderData, "Theta_pFD_pCD_vs_W_pFDpCD", "Theta_nFD_pCD_vs_W_nFDpCD", "Theta_nucFD_nucCD_vs_W_FSR_2N", 2);
    //</editor-fold>

    //<editor-fold desc="04_Energy_dist_comp_Sim">
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "E_{e} (All Int., pFDpCD)", "E_{e} (All Int., nFDpCD)",
               "E_{e} (All Int., nFDpCD)", EnergyComp_E_e_Sim_FolderData, "E_e_All_Int_pFDpCD", "E_e_All_Int_nFDpCD", "E_e_FSR", 1);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "E_{e} vs. #theta_{e} (All Int., pFDpCD)",
               "E_{e} vs. #theta_{e} (All Int., nFDpCD)", "E_{e} vs. #theta_{e} (All Int., nFDpCD)",
               EnergyComp_E_e_Sim_FolderData, "E_e_VS_Theta_e_All_Int_pFDpCD", "E_e_VS_Theta_e_All_Int_nFDpCD", "E_e_VS_Theta_e_All_Int_FSR_2N", 2);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "E_{cal} vs. #deltaP_{T,tot} (All Int., pFDpCD)",
               "E_{cal} vs. #deltaP_{T,tot} (All Int., nFDpCD)", "E_{cal} vs. #deltaP_{T,tot} (All Int., nFDpCD)",
               EnergyComp_E_cal_Sim_FolderData, "Ecal_vs_dP_T_tot_pFDpCD", "Ecal_vs_dP_T_tot_nFDpCD", "Ecal_vs_dP_T_tot_FSR_2N", 2);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "E_{cal} vs. #delta#alpha_{T,tot} (All Int., pFDpCD)",
               "E_{cal} vs. #delta#alpha_{T,tot} (All Int., nFDpCD)", "E_{cal} vs. #delta#alpha_{T,tot} (All Int., nFDpCD)",
               EnergyComp_E_cal_Sim_FolderData, "Ecal_vs_dAlpha_T_tot_pFDpCD", "Ecal_vs_dAlpha_T_tot_nFDpCD", "Ecal_vs_dAlpha_T_tot_FSR_2N", 3);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "E_{cal} vs. W (All Int., pFDpCD)",
               "E_{cal} vs. W (All Int., nFDpCD)", "E_{cal} vs. W (All Int., nFDpCD)",
               EnergyComp_E_cal_Sim_FolderData, "Ecal_vs_W_pFDpCD", "Ecal_vs_W_nFDpCD", "Ecal_vs_W_FSR_2N", 4);
    //</editor-fold>

    //<editor-fold desc="04_Energy_dist_comp_Data">
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "FD", "E_{e} (All Int., pFDpCD)", "E_{e} (All Int., nFDpCD)",
               "E_{e} (All Int., nFDpCD)", EnergyComp_E_e_Data_FolderData, "E_e_All_Int_pFDpCD", "E_e_All_Int_nFDpCD", "E_e_FSR", 1);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "E_{e} vs. #theta_{e} (All Int., pFDpCD)",
               "E_{e} vs. #theta_{e} (All Int., nFDpCD)", "E_{e} vs. #theta_{e} (All Int., nFDpCD)",
               EnergyComp_E_e_Data_FolderData, "E_e_VS_Theta_e_All_Int_pFDpCD", "E_e_VS_Theta_e_All_Int_nFDpCD", "E_e_VS_Theta_e_All_Int_FSR_2N", 2);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "E_{cal} vs. #deltaP_{T,tot} (All Int., pFDpCD)",
               "E_{cal} vs. #deltaP_{T,tot} (All Int., nFDpCD)", "E_{cal} vs. #deltaP_{T,tot} (All Int., nFDpCD)",
               EnergyComp_E_cal_Data_FolderData, "Ecal_vs_dP_T_tot_pFDpCD", "Ecal_vs_dP_T_tot_nFDpCD", "Ecal_vs_dP_T_tot_FSR_2N", 2);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "E_{cal} vs. #delta#alpha_{T,tot} (All Int., pFDpCD)",
               "E_{cal} vs. #delta#alpha_{T,tot} (All Int., nFDpCD)", "E_{cal} vs. #delta#alpha_{T,tot} (All Int., nFDpCD)",
               EnergyComp_E_cal_Data_FolderData, "Ecal_vs_dAlpha_T_tot_pFDpCD", "Ecal_vs_dAlpha_T_tot_nFDpCD", "Ecal_vs_dAlpha_T_tot_FSR_2N", 3);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "E_{cal} vs. W (All Int., pFDpCD)",
               "E_{cal} vs. W (All Int., nFDpCD)", "E_{cal} vs. W (All Int., nFDpCD)",
               EnergyComp_E_cal_Data_FolderData, "Ecal_vs_W_pFDpCD", "Ecal_vs_W_nFDpCD", "Ecal_vs_W_FSR_2N", 4);
    //</editor-fold>

    //<editor-fold desc="05_TKI_comp_Sim">
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "#deltaP_{T,tot} (pFDpCD)", "#deltaP_{T,tot} (nFDpCD)",
               "#deltaP_{T,tot} (nFDpCD)", TKIComp_dP_T_Sim_FolderData, "dP_T_pFDpCD", "dP_T_nFDpCD", "dP_T_FSR", 1);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#deltaP_{T,tot} vs. W (All Int., pFDpCD)",
               "#deltaP_{T,tot} vs. W (All Int., nFDpCD)", "#deltaP_{T,tot} vs. W (All Int., nFDpCD)",
               TKIComp_dP_T_Sim_FolderData, "dP_T_tot_vs_W_pFDpCD", "dP_T_tot_vs_W_nFDpCD", "dP_T_tot_vs_W_FSR_2N", 3);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH2D", "FD", "#delta#alpha_{T,tot} vs. W (All Int., pFDpCD)",
               "#delta#alpha_{T,tot} vs. W (All Int., nFDpCD)", "#delta#alpha_{T,tot} vs. W (All Int., nFDpCD)",
               TKIComp_dAlpha_T_Sim_FolderData, "dAlpha_T_tot_vs_W_pFDpCD", "dAlpha_T_tot_vs_W_nFDpCD", "dAlpha_T_tot_vs_W_FSR_2N", 3);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH1D", "FD", "#deltaP_{T,tot} (pFDpCD)", "#deltaP_{T,tot} (nFDpCD)",
               "#deltaP_{T,tot} (nFDpCD)", TKIComp_dP_T_Data_FolderData, "dP_T_pFDpCD", "dP_T_nFDpCD", "dP_T_FSR", 1);
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#deltaP_{T,tot} vs. W (All Int., pFDpCD)",
               "#deltaP_{T,tot} vs. W (All Int., nFDpCD)", "#deltaP_{T,tot} vs. W (All Int., nFDpCD)",
               TKIComp_dP_T_Data_FolderData, "dP_T_tot_vs_W_pFDpCD", "dP_T_tot_vs_W_nFDpCD", "dP_T_tot_vs_W_FSR_2N", 3);
    ...
    FSRPlotter(C, MScThesisPlots, Final_wSaC_Data, SampleName, "2N", "TH2D", "FD", "#delta#alpha_{T,tot} vs. W (All Int., pFDpCD)",
               "#delta#alpha_{T,tot} vs. W (All Int., nFDpCD)", "#delta#alpha_{T,tot} vs. W (All Int., nFDpCD)",
               TKIComp_dAlpha_T_Data_FolderData, "dAlpha_T_tot_vs_W_pFDpCD", "dAlpha_T_tot_vs_W_nFDpCD", "dAlpha_T_tot_vs_W_FSR_2N", 3);
