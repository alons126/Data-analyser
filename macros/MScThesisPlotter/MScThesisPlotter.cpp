...
//                                           "/Proton_resolution_plots_-_C12x4_simulation_G18_Q204_6GeV.root";
    ...
    TCanvas *Canv = new TCanvas("c1", "c2", utilities.GetStandardCanvasWidth() * 1.25, utilities.GetStandardCanvasHeight() * 1.25); // normal res
...
//
//    HistPlotter2D(Canv, MScThesisPlots, plots_Preselection_only, "#beta vs. P (all particles, 1e cut, CD)", SampleName, ElectronIDFolderSimBC, "02_Beta_vs_P_CD_all_par_1e_cut");
//    HistPlotter2D(Canv, MScThesisPlots, plots_Preselection_only, "#beta vs. P (all particles, 1e cut, FD)", SampleName, ElectronIDFolderSimBC, "02_Beta_vs_P_FD_all_par_1e_cut");
//
...
//    HistPlotter2D(Canv, MScThesisPlots, plots_woChi2, "#Delta#theta_{LnFD,e} vs. #Delta#phi_{LnFD,e} BV (1e cut, FD)", SampleName, NeutralsFDIDFolderSimBC,
//                  "01_ECAL_veto_LnFD_e_1e_cut");
//    HistPlotter2D(Canv, MScThesisPlots, plots_woChi2, "#Delta#theta_{LnFD,pFD} vs. #Delta#phi_{LnFD,pFD} BV (1e cut, FD)", SampleName, NeutralsFDIDFolderSimBC,
//                  "01_ECAL_veto_LnFD_pDF_1e_cut");
//    HistPlotter2D(Canv, MScThesisPlots, plots_woChi2, "#Delta#theta_{nFD,e} vs. #Delta#phi_{nFD,e} BV (1e cut, FD)", SampleName, NeutralsFDIDFolderSimBC,
//                  "02_ECAL_veto_nFD_e_1e_cut");
//    HistPlotter2D(Canv, MScThesisPlots, plots_woChi2, "#Delta#theta_{nFD,pFD} vs. #Delta#phi_{nFD,pFD} BV (1e cut, FD)", SampleName, NeutralsFDIDFolderSimBC,
...
////    HistPlotter1D(Canv, MScThesisPlots, plots_woChi2,
////                  "Reco FD neutrons momentum BPID (1e cut, FD)", SampleName,
////                  NeutralsFDIDFolderSimBC, "03a_P_nFD_BPID_1e_cut_FD");
//    HistPlotter1D(Canv, MScThesisPlots, plots_woChi2, "FD neutron momentum BPID - ZOOMOUT (1e_cut, FD)", SampleName, NeutralsFDIDFolderSimBC, "03b_P_nFD_ZOOMOUT_BPID_1e_cut_FD");
////    HistPlotter1D(Canv, MScThesisPlots, plots_woChi2,
...
//    HistPlotter1D(Canv, MScThesisPlots, plots_Efficiency_wFC_wMomTh, "Proton theta #epsilon_{eff} (1p)", SampleName, EfficiencyWithFCFolderSim, "02_proton_theta_eff_1p_wMomTh");
//
...
//
////    /* momRes test */
////    GraphPlotter1D(Canv, MScThesisPlots, plots_momResS2_FittedPlots, "Fitted neutron resolution slice width", "g_Std_pol1_wKC",
////                   SampleName, MomResS2FolderSim, "01_g_Std_pol1_wKC"); // Important!
////    GraphPlotter1D(Canv, MScThesisPlots, plots_momResS2_FittedPlots, "Fitted neutron resolution slice mean", "g_Corr_pol1_wKC",
...
//               MomComp_ElecMom_2N_Reco_Sim_FolderData, "P_e_pFDpCD_FD_2N", "P_e_nFDpCD_FD_2N", "P_e_FSR_2N", 2);
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "1N", "TH1D", "FD", "FD proton momentum APID&PS", "Leading FD neutron momentum APID&NC",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "FD proton momentum", "FD neutron momentum", "FD neutron momentum",
               MomComp_NucMom_2N_Reco_Sim_FolderData, "P_pFD_pFDpCD_FD", "P_nFD_nFDpCD_FD", "P_nucFD_FSR_2N", 1);
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "CD proton momentum", "CD proton momentum", "CD proton momentum",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "Leading proton momentum", "Leading nucleon momentum",
               "Leading nucleon momentum",
               MomComp_NucMom_2N_Reco_Sim_FolderData, "P_pL_pFDpCD_FD", "P_nL_nFDpCD_FD", "P_nucL_FSR_2N", 4);
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "Recoil proton momentum", "Recoil nucleon momentum", "Recoil nucleon momentum",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "#vec{P}_{tot}-#vec{q} distribution", "#vec{P}_{tot}-#vec{q} distribution",
               "#vec{P}_{tot}-#vec{q} distribution", MomComp_P_miss_Sim_FolderData, "P_miss_pFDpCD", "P_miss_nFDpCD", "P_miss_FSR_2N", 1);

    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "Total nucleon momentum (3-vector)", "Total nucleon momentum (3-vector)",
               "Total nucleon 3-momentum", MomComp_TotAndRel_Mom_Sim_FolderData, "P_3rel_pFDpCD", "P_3rel_nFDpCD", "P_rel_FSR_2N", 1);
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "Relative nucleon momentum (3-vector)", "Relative nucleon momentum (3-vector)",
...
//               MomComp_ElecMom_2N_Reco_Data_FolderData, "P_e_pFDpCD_FD_2N", "P_e_nFDpCD_FD_2N", "P_e_FSR_2N", 2);
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "W distribution (All Int., pFDpCD)", "W distribution (All Int., nFDpCD)",
               "W distribution (All Int., nFDpCD)", InvMassComp_Sim_FolderData, "W_All_Int_pFDpCD", "W_All_Int_nFDpCD", "W_FSR", 1);
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "Q^{2} (pFDpCD, FD)", "Q^{2} (nFDpCD, FD)", "Q^{2} (nFDpCD, FD)",
               InvMassComp_Sim_FolderData, "Q2_pFDpCD", "Q2_nFDpCD", "Q2_FSR", 2);
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "#theta_{e} (All Int., pFDpCD, FD)", "#theta_{e} (All Int., nFDpCD, FD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "#theta_{pFD} (All Int., pFDpCD)", "#theta_{nFD} (All Int., nFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{pCD} (All Int., pFDpCD)", "#theta_{pCD} (All Int., nFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{tot} (All Int., pFDpCD)", "#theta_{tot} (All Int., nFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{rel} (All Int., pFDpCD)", "#theta_{rel} (All Int., nFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{P}_{e},#vec{P}_{tot}} (All Int., pFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{tot}} (All Int., pFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{P}_{pL}-#vec{q},#vec{P}_{pR}} (All Int., pFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{pL}} (All Int., pFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{pR}} (All Int., pFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "#theta_{#vec{q},#vec{P}_{pFD}} (All Int., pFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{#vec{q},#vec{P}_{pCD}} (All Int., pFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "CD", "#theta_{pFD,pCD} (All Int., pFDpCD)", "#theta_{nFD,pCD} (All Int., nFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "E_{e} (All Int., pFDpCD)", "E_{e} (All Int., nFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "#omega around #theta_{e} = 15#circ (All Int., pFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "E_{cal} reco. (All Int., pFDpCD)", "E_{cal} reco. (All Int., nFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "#deltaP_{T,tot} (pFDpCD)", "#deltaP_{T,tot} (nFDpCD)",
    ...
    FSRPlotter(utilities, Canv, MScThesisPlots, Final_wSaC_Sim, SampleName, "2N", "TH1D", "FD", "#delta#alpha_{T,tot} (pFDpCD)", "#delta#alpha_{T,tot} (nFDpCD)",
