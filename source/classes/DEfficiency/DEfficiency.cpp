...
void DEfficiency::LoadHistograms(string &SampleName, const hPlot1D &TLPlot, const hPlot1D &RPlot) {
    ...
    RPlot_SaveNamePath = RPlot.GetHistogram1DSaveNamePath();
    ...
    TLPlot_SaveNamePath = TLPlot.GetHistogram1DSaveNamePath();
}
//</editor-fold>
...
void DEfficiency::LoadHistograms(string &SampleName, const hPlot1D &TLPlot, TH1D *RPlot) {
    ...
    string RPlot_Clone_StatsTitle = "reco. " + StatsTitle + " - cloned";
    TH1D *RPlot_Clone = (TH1D *) RPlot->Clone((RPlot_Clone_StatsTitle).c_str());
    string RPlot_Clone_test_StatsTitle = "reco. " + StatsTitle + " - cloned test";
    TH1D *RPlot_Clone_test = (TH1D *) RPlot->Clone((RPlot_Clone_test_StatsTitle).c_str());
    string RPlot_Clone_test_rebined_StatsTitle = "reco. " + StatsTitle + " - cloned test rebined";
    ...
    string TLPlot_Clone_StatsTitle = "Truth " + StatsTitle + " - cloned";
    TH1D *TLPlot_Clone = (TH1D *) Histogram1D_Truth->Clone((TLPlot_Clone_StatsTitle).c_str());
    string TLPlot_Clone_test_StatsTitle = "Truth " + StatsTitle + " - cloned test";
...
//    string ACorrectionYLabel = "#epsilon_{eff} = " + xLabel_REC + "^{rec}" + "/" + xLabel_Truth;
    ...
    string ACorrectionSaveDir = SetSaveDir(ACorrectionRecTitle, TLPlot_SaveNamePath);
    string ACorrectionTestSaveDir = SetSaveDir(ACorrectionRecTitle, TLPlot_SaveNamePath, "test");
...
//<editor-fold desc="DrawAndSaveACorrPlots function">
void DEfficiency::DrawAndSaveACorrPlots(bool save_ACorr_data, string &SampleName, const hPlot1D &TLPlot, TH1D *RPlot,
                                        TList *Histogram_list, TList *ACorr_data, string &ACorr_data_Dir) {
//    //<editor-fold desc="Canvas definitions">
//    TCanvas *Canvas = new TCanvas("Canvas", "Canvas", 1000, 750); // normal res
////    TCanvas *Canvas = new TCanvas("canvas", "canvas", 2000, 1500); // high res
