//
// Created by alons on 12/02/2023.
//

#ifndef DETECTORSIMULATIONANALYSER_C_GENERALCLASSES_H
#define DETECTORSIMULATIONANALYSER_C_GENERALCLASSES_H
...
#endif //DETECTORSIMULATIONANALYSER_C_GENERALCLASSES_H
