...
// Private attributes ---------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    vector<std::string> Nphe_Daughter_Folders = {"", "01_1e_cut", "02_1p", "03_2p"};
    //</editor-fold>
    ...
    vector<std::string> Chi2_Daughter_Folders = {"", "01_All_e", "02_1e_cut", "03_1p", "04_1e2p_BC-AC_cut_tests", "05_2p"};
    //</editor-fold>
    ...
    vector<std::string> Vertex_Daughter_Folders = {"", "02_dV_plots/01_1p", "02_dV_plots/02_1e2p", "02_dV_plots/03_2p",
    ...
    vector<std::string> SF_Daughter_Folders = {"", "01_1e_cut", "01_1e_cut/SF_plots", "01_1e_cut/SF_VS_P_e_plots", "02_1p", "02_1p/SF_plots", "02_1p/SF_VS_P_e_plots",
    ...
    vector<std::string> fiducial_Daughter_Folders = {"", "01_1e_cut", "01_1e_cut/PCAL", "02_1p", "02_1p/PCAL", "03_2p", "03_2p/PCAL"};
    //</editor-fold>
    ...
    vector<std::string> Momentum_Daughter_Folders = {"", "01_1e_cut", "02_1p", "03_1e2p", "04_2p"};
    //</editor-fold>
    ...
    vector<std::string> Angle_Daughter_Folders = {"", "01_All_e", "01_All_e/01_Theta_e_All_e_plots", "01_All_e/02_Phi_e_All_e_plots",
                                                  ...
                                                  "06_2p/04_Opening_angles_2p_plots/01_Theta_p1_p2_by_interaction", "07_1e2pXy", "07_1e2pXy/01_Theta_e_1e2pXy_plots",
                                                  "07_1e2pXy/02_Phi_e_1e2pXy_plots", "07_1e2pXy/03_Theta_e_VS_Phi_e_1e2pXy_plots",
    ...
    vector<std::string> Q2_Daughter_Folders = {"", "01_All_e", "02_1e_cut", "03_1p", "04_1e2p", "05_2p"};
    //</editor-fold>

    //<editor-fold desc="E_e plots directories">
    bool create_E_e_Dir = true;
    std::string E_e_Parent_Directory = "05_E_e_plots";
    vector<std::string> E_e_Daughter_Folders = {"", "01_1e_cut", "01_1e_cut/E_e_plots_1e_cut", "01_1e_cut/E_e_VS_Theta_e_1e_cut", "02_1p", "02_1p/E_e_plots_1p",
                                                "02_1p/E_e_VS_Theta_e_1p", "02_1p/E_e_plots_1p/Around_15_deg_1p", "03_2p", "03_2p/E_e_plots_2p",
                                                "03_2p/E_e_VS_Theta_e_2p", "03_2p/E_e_plots_2p/Around_15_deg_2p"};
    //</editor-fold>

    //<editor-fold desc="ETrans plots directories">
    bool create_ETrans_Dir = true;
    std::string ETrans_Parent_Directory = "06_ET_plots";
    vector<std::string> ETrans_Daughter_Folders = {"", "02_2p", "02_2p/02_Around_15_Deg_2p", "02_2p/02_Around_15_Deg_2p/00_All_interactions",
                                                   ...
                                                   "02_2p/01_Every_theta_e_2p/04_DIS_only", "01_1p", "01_1p/02_Around_15_Deg_1p",
                                                   ...
                                                   "01_1p/01_Every_theta_e_1p/01_QEL_only", "01_1p/01_Every_theta_e_1p/02_MEC_only",
                                                   "01_1p/01_Every_theta_e_1p/03_RES_only", "01_1p/01_Every_theta_e_1p/04_DIS_only"};
    //</editor-fold>

    //<editor-fold desc="Ecal plots directories">
    bool create_Ecal_Dir = true;
    std::string Ecal_Parent_Directory = "07_Ecal_rec_plots";
    vector<std::string> Ecal_Daughter_Folders = {"", "02_2p", "02_2p/01_Ecal_rec_by_reaction_2p/00_All_interactions", "02_2p/01_Ecal_rec_by_reaction_2p/01_QEL_only",
                                                 ...
                                                 "02_2p/03_Chi2_for_Ecal_above_Ebeam_2p", "01_1p", "01_1p/01_Ecal_rec_by_reaction_1p/00_All_interactions",
    ...
    vector<std::string> TVariables_Daughter_Folders = {"", "02_2p", "02_2p/01_dP_T_2p", "02_2p/02_dAlpha_T_2p", "02_2p/03_dPhi_T_2p", "01_1p", "01_1p/01_dP_T_1p",
