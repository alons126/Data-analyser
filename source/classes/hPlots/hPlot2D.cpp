...
void hPlot2D::hDrawAndSave(std::string &SampleName, TCanvas *h2DCanvas, TList *hList, TF1 *Beta_function1, TF1 *Beta_function2,
...
void hPlot2D::hDrawAndSave(std::string &SampleName, TCanvas *h2DCanvas, TList *hList, TF1 *Beta_function1, std::string particle1, bool showStats, bool plot_legend) {
...
void hPlot2D::hDrawAndSave(std::string &SampleName, TCanvas *h2DCanvas, TList *hList, TF1 *Beta_function1, std::string particle1, TF1 *Beta_function2,
